...
Zeeq uses message queuing for background work and durable write buffering. This allows flexibility to use different messaging channels based on desired deployment target. 

Messaging serves many purposes in Zeeq including allowing fast responses to incoming webhooks, durable queueing of work, and buffering write-heavy workloads. 
