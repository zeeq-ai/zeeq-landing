...
Store this in your local environment as `ZEEQ_OTEL_ACCESS_TOKEN` in your shell file (`.zshrc`, `.bashrc`, `$PROFILE`, etc.).
...
{
  "env": {
    "OTEL_EXPORTER_OTLP_HEADERS": "Authorization=Bearer <ZEEQ_OTEL_ACCESS_TOKEN_HERE>",
  }
}
```
