...
The extension is published to npm as [`@zeeq-ai/zeeq-app-pi-telemetry`](https://www.npmjs.com/package/@zeeq-ai/zeeq-app-pi-telemetry). Run this from the root of the repository you want to emit telemetry from:
